...
void hb_unlock_wr(uint64_t * ptr);
void hb_unlock_rd(uint64_t * ptr);
void hb_writeLock(uint64_t * ptr);
void hb_readLock(uint64_t * ptr);

// does lock with CAS on low bits of ptr
void lb_unlock_wr(uint64_t * ptr);
void lb_unlock_rd(uint64_t * ptr);
void lb_writeLock(uint64_t * ptr);
void lb_readLock(uint64_t * ptr);

// does lock with CAS on an uint64_t
void ab_unlock_wr(uint64_t * ptr);
void ab_unlock_rd(uint64_t * ptr);
void ab_writeLock(uint64_t * ptr);
void ab_readLock(uint64_t * ptr);
